...
Timer.SetInterval(function()
	...
	if (Halloween.local_character) then
		table.insert(ignored_actors, Halloween.local_character)
	end
	...
	elseif (nametag_active ~= "") then
		nametag_active = ""
		HUD:CallEvent("ShowNameTag", false)
	end
end, 100)